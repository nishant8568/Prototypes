...
//       });
// });
videochatModule.controller('videoChatController', function ($scope, $http, authService, databaseService, $stateParams, $location, $window, $timeout, config) {
    'use strict';
    var vm = this;
    var sendChannel;
    var isChannelReady;
    ...
    $scope.callend = function () {
        ...
        if (callend.callendedby == callerdetails.receivername) {
            ...
            callend.startDate = callerdetails.startDate;
            callend.duration = 1234;
            alert("callend.." + JSON.stringify(callend));
